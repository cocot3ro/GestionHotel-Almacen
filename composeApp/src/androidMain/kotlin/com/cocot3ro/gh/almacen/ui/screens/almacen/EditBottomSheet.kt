...
fun EditBottomSheet(
    ...
    ModalBottomSheet(
        ...
        if (viewModel.showImageSelection) {
            ModalBottomSheet(onDismissRequest = { viewModel.updateShowImageSelection(false) }) {
                TextButton(
                    modifier = Modifier.align(Alignment.End),
                    onClick = { viewModel.updateShowImageSelection(showImageSelection = false) }
                ) {
                    Text(text = "Cancelar")
                }
